		...
		return (
			<div>
				...
				<Container fluid>
					<Row>
						<Col xs lg="5">
							<ProgressBar style={{ height: 30 + 'px' }} max={gameSettings.team1.MAX_LIFE}>
								<ProgressBar variant="danger" max={gameSettings.team1.MAX_LIFE} now={gameSettings.team1.MAX_LIFE - gameSettings.team1.life} key={1} />
								<ProgressBar variant="warning" animated max={gameSettings.team1.MAX_LIFE} now={gameSettings.team1.life} key={2} />
							</ProgressBar>
						</Col>
						<Col xs lg="2">
						...
						<Col xs lg="5">
							<ProgressBar style={{ height: 30 + 'px' }} max={gameSettings.team2.MAX_LIFE}>
								<ProgressBar variant="warning" animated now={gameSettings.team2.life} max={gameSettings.team2.MAX_LIFE} key={1} />
								<ProgressBar variant="danger" max={gameSettings.team2.MAX_LIFE} now={gameSettings.team2.MAX_LIFE - gameSettings.team2.life} key={2} />
							</ProgressBar>
						</Col>
					</Row>
					<Row>
						<Col xs lg="3">
							<ProgressBar style={{ height: 8 + 'px' }} max={gameSettings.team1.MAX_ENERGY}>
								<ProgressBar
									animated
									// variant="success"
						...
						<Col xs lg="6"></Col>
						<Col xs lg="3">
							<ProgressBar style={{ height: 8 + 'px', direction: 'rtl' }} max={gameSettings.team2.MAX_ENERGY}>
								<ProgressBar
									animated
					...
					<Row>
						<Col xs lg="2" className="text-left">
							<h3 style={{ color: '#995cf1' }}>{gameSettings.team1.name}</h3>
						</Col>
						...
						<Col xs lg="2" className="text-right">
							<h3 style={{ color: '#f0555b' }}>{gameSettings.team2.name}</h3>
						</Col>
					</Row>
					<Row>
						<Col xs lg="2" className="text-left">
							<Animated animationOut="zoomOut" animationOutDuration={timeAnimation} isVisible={visible1}>
						...
						<Col xs lg="2" className="text-right">
							<Animated animationOut="zoomOut" animationOutDuration={timeAnimation} isVisible={visible2}>
